  ...
  return (
    <group {...props}>
      ...
      <mesh 
        ...
        position={[-2.412, -0.472 + (parallaxOffset*.5) + (bobOffset*1.4), 2.163]} 
        rotation={[Math.PI + rotation.x*.9, rotation.y*.7, Math.PI]}>
        <MeshTransmissionMaterial {...materialProps} samples={4} />
      </mesh>
      <mesh 
        geometry={torusGeometry} 
        position={[2.465, -0.326 + (parallaxOffset*.5) + (bobOffset*.9), 4.193]} 
      ...
      <mesh 
        ...
        position={[1.672, 1.086 + (parallaxOffset*.7) + (bobOffset*1), 3.07]} 
      ...
      <mesh 
        ...
        position={[-1.858, 1.707 + (parallaxOffset*1.4) + (bobOffset*.9), 0.389]} 
        rotation={[1.763 + rotation.x*.3, 0.961 + rotation.y*.8, 2.109]}>
        <MeshTransmissionMaterial {...materialProps} samples={4} />
      </mesh>
      <mesh 
        geometry={sphere001Geometry} 
        position={[-2.025, 0.009 + (parallaxOffset*.6) + (bobOffset*1.9), 3.35]} 
      ...
      <mesh 
        ...
        position={[1.433, -0.728 + (parallaxOffset*.8) + (bobOffset*.7), 2.432]} 
        rotation={[2.528 + rotation.x*.9, -1.137 + rotation.y*1.5, 1.708]}>
        <MeshTransmissionMaterial {...materialProps} samples={4} />
      </mesh>
      <mesh 
        geometry={hollowCubeGeometry} 
        position={[1.89, 1.624 + (parallaxOffset*.9) + (bobOffset*1.6), 0.561]} 
      ...
      <mesh 
        ...
        position={[-0.947, 1.947 + (parallaxOffset*.4) + (bobOffset*1.9), -0.169]} 
